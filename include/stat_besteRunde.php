...
foreach ($besteRunde as $spielerRundeId => $rundenDaten) {
    $besteRunde[$spielerRundeId]['schnittSpielePunktePlusMinus'] = $besteRunde[$spielerRundeId]['punktePlusMinus'] / max($besteRunde[$spielerRundeId]['spiele'], 1);
    $besteRunde[$spielerRundeId]['schnittSpielePunkteSumme'] = $besteRunde[$spielerRundeId]['punkteSumme'] / max($besteRunde[$spielerRundeId]['spiele'], 1);
    $besteRunde[$spielerRundeId]['schnittSiegeSpiele'] = $besteRunde[$spielerRundeId]['siege'] / max($besteRunde[$spielerRundeId]['spiele'], 1) * 100;
